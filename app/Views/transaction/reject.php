                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10 text-success text-md">
                                        <p>Anda melakukan pembatalan untuk transaksi ini. Mohon isikan keterangan atas pembatalan tersebut.</p>
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    <label for="aprOtp" class="col-sm-2 col-form-label text-right">Alasan</label>
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control" id="aprNote" name="aprNote" require>
                                    </div>
                                </div>
